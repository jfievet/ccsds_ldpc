...
use work.ldpc_encoder_16k_23_config_pkg.all;
use work.ldpc_encoder_16k_23_qc_rom_pkg.all;

entity ldpc_encoder_16k_23 is
  port (
...
end entity ldpc_encoder_16k_23;

architecture rtl of ldpc_encoder_16k_23 is
...
begin
  ...
  begin
    rom_data_s(rom_index) <= C_LDPC_QC_ROM_BANK_16K_23(rom_index)(rom_row_block_s);
