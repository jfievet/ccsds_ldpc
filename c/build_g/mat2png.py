...
def load_any_mat(path, variable_name="G"):
    try:
...
def main():
    parser = argparse.ArgumentParser(
        description="Render a CCSDS LDPC sparse-text G .mat file to a high-resolution PNG."
    )
    ...
    parser.add_argument(
        "--variable",
        default="G",
        help="Variable name for binary MATLAB .mat files. Default: G",
    )
    parser.add_argument(
        "--downsample",
        type=int,
