...
library work;
use work.ldpc_encoder_4k_45_config_pkg.all;
use work.ldpc_encoder_4k_45_vectors_pkg.all;

entity tb_vunit_ldpc_encoder_4k_45 is
  generic (
    runner_cfg : string
  );
end entity tb_vunit_ldpc_encoder_4k_45;

architecture sim of tb_vunit_ldpc_encoder_4k_45 is
...
begin
  ...
  dut : entity work.ldpc_encoder_4k_45
    port map (
      clock_i        => clock_i,
      reset_i        => reset_i,
      data_i         => data_i,
