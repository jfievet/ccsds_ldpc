...
use work.ldpc_encoder_16k_23_vectors_pkg.all;

entity tb_vunit_ldpc_encoder_16k_23 is
  generic (
    runner_cfg : string
  );
end entity tb_vunit_ldpc_encoder_16k_23;

architecture sim of tb_vunit_ldpc_encoder_16k_23 is
...
begin
  ...
  dut : entity work.ldpc_encoder_16k_23
    port map (
      clock_i        => clock_i,
      reset_i        => reset_i,
      data_i         => data_i,
