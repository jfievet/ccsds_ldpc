...
use work.ldpc_encoder_16k_12_config_pkg.all;
use work.ldpc_encoder_16k_12_qc_rom_pkg.all;

entity ldpc_encoder_16k_12 is
  port (
...
end entity ldpc_encoder_16k_12;

architecture rtl of ldpc_encoder_16k_12 is
...
begin
  ...
  begin
    rom_data_s(rom_index) <= C_LDPC_QC_ROM_BANK_16K_12(rom_index)(rom_row_block_s);
