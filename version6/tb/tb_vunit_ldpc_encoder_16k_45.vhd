...
use work.ldpc_encoder_16k_45_vectors_pkg.all;

entity tb_vunit_ldpc_encoder_16k_45 is
  generic (
    runner_cfg : string
  );
end entity tb_vunit_ldpc_encoder_16k_45;

architecture sim of tb_vunit_ldpc_encoder_16k_45 is
...
begin
  ...
  dut : entity work.ldpc_encoder_16k_45
    port map (
      clock_i        => clock_i,
      reset_i        => reset_i,
      data_i         => data_i,
